...
# Data for fitting: extend range by margin on both sides
...
# Data for plotting and R^2 evaluation: only T_exp to T_max
...
# Evaluate R^2 on the plotting/eval range
...
plt.xlabel("Days after t = 58144.112")
