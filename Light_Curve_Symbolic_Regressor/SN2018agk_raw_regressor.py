...
df = pd.read_csv('/Users/mark/Documents/Summer UROP 2025/One_Rising_Component_Curves/SN2018agk_raw_data.csv', usecols=['time', 'flux', 'flux_err'])
...
for i in range(5, len(y_temp)):
    ...
    if y_temp[i] > mean_flux + 3 * std_flux:
        T_exp = x_temp[i]
        break
